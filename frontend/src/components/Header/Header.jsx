...
function Header() {
    ...
    const [channelProfile, setChannelProfile] = useState(() => ({
        ...DEFAULT_CHANNEL_PROFILE,
        avatar: authUserData?.avatar || DEFAULT_CHANNEL_PROFILE.avatar,
        fullName: authUserData?.fullName || DEFAULT_CHANNEL_PROFILE.fullName,
        ...
        const fetchChannelProfile = async () => {
            ...
            try {
                ...
                if (isMounted) {
                    setChannelProfile((prevProfile) => ({
                        ...DEFAULT_CHANNEL_PROFILE,
                        avatar: prevProfile.avatar || DEFAULT_CHANNEL_PROFILE.avatar,
                        fullName: prevProfile.fullName || DEFAULT_CHANNEL_PROFILE.fullName,
    ...
    const handleProfileClick = () => {
        ...
        navigate(`/channel/${encodeURIComponent(channelProfile._id)}/editing/contact-info`)
    }
                    ...
                    </ul>
                    {
                        ...
                        ? (
                            ...
                            className="flex w-full gap-4 text-left sm:items-center">
                                ...
                                {
                                    !channelProfile.fullName && !channelProfile.username
                                    ? <h1>Loading...</h1>
                                    : (
                                        <>
                                        <h6 className="font-semibold">{channelProfile.fullName}</h6>
                                        <p className="text-sm text-gray-300">@{channelProfile.username}</p>
                                        </>
                                    )
                                }
                                </div>
